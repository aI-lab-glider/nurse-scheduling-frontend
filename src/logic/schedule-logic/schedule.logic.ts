...
export class ScheduleLogic implements ScheduleProvider {
  ...
  constructor(
    ...
    this.update(scheduleModel, mode, shift);
  }
  ...
  public update(schedule: ScheduleDataModel, mode, shift: ShiftModel): void {
    this.uuid = schedule.schedule_info.UUID ?? "";
    this.sections = this.createSections(schedule, shift);
  ...
  public createSections(scheduleModel: ScheduleDataModel, shifts: ShiftModel): Sections {
    const {
