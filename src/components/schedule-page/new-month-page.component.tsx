...
export function NewMonthPlanComponent(): JSX.Element {
  ...
  const hasValidNext =
    nextMonth !== undefined && nextMonth.month_info.dates.length > 0 && !nextMonth.isAutoGenerated;
  const hasValidPrevious =
    prevMonth !== undefined && prevMonth.month_info.dates.length > 0 && !prevMonth.isAutoGenerated;
